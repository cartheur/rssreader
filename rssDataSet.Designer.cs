...
SELECT ChannelID, Title, URL, LastUpdated, FolderID FROM Channel WHERE (ChannelID = @ChannelID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT ChannelID, Title, URL, LastUpdated, FolderID FROM dbo.Channel";
        ...
        public virtual int FillBy(rssDataSet.ChannelDataTable dataTable) {
